...
public class GvrController : MonoBehaviour {
  ...
  public event OnControllerUpdateEvent OnControllerUpdate;
	...
	private static  float[] intdata;
	private static float xOri;
	private static float yOri;
	private static float zOri;
	private static float wOri;
	...
	void Update()
	{
//		intdata = providerObject.Call<float[]> ("getfloatArray");
//		xOri = -intdata [3];
//		yOri = intdata [1];
//		zOri = intdata [2];
//		wOri = intdata [0];
		//Debug.Log ("floatDatas=="+intdata.Length);
	}
...
//	}
  ...
  public static Quaternion Orientation {       //四元数
    get {
		...
		//	Quaternion mQuaternion = new Quaternion (wOri,xOri,yOri,zOri);
		//	Debug.Log ("papapa="+intdata[0]+"    "+intdata[1]+"   "+intdata[2]+"  "+intdata[3]);
		//return mQuaternion;
